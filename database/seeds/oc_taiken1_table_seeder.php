    ...
    public function run()
{
      ...
      $taiken2=array(2,4,5,10,11,14,15,17,19,20);
      $taiken3=array(2,3,6,7,10,13,16,18,20,20);
      $taiken4=array(1,3,4,7,11,12,13,14,15,18,20);
      for($i=1;$i<50;$i++){
        $id_rand=rand(1,6);
        $taiken_rand=rand(1,20);
        $hoge=array(1=>$taiken1,2=>$taiken1,3=>$taiken1,4=>$taiken2,5=>$taiken3,6=>$taiken4);
